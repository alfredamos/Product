...
exports.adminAndSelfMiddleware = void 0;
const http_errors_1 = __importDefault(require("http-errors"));
const http_status_codes_1 = require("http-status-codes");
const client_1 = require("@prisma/client");
const adminAndSelfMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    next((0, http_errors_1.default)(http_status_codes_1.StatusCodes.FORBIDDEN, "You are not authorized to view this resource."));
});
exports.adminAndSelfMiddleware = adminAndSelfMiddleware;
