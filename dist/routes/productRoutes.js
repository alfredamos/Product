...
const featureProductValidationMiddleware_1 = require("../middleware/featureProductValidationMiddleware");
...
router
    .route("/feature")
    .patch(featureProductValidationMiddleware_1.featureProductValidationMiddleware, authenticationMiddleware_1.authenticationMiddleware, (0, roleAuthorizationMiddleware_1.roleAuthorizationMiddleware)("Admin"), productController_1.updateFeatureProduct);
router
    .route("/:id")
